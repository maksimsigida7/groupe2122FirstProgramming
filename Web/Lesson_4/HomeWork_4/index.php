...
"description" => "Тут описание работы разработчиком тут описание работы
разработчиком тут описание работы разработчиком тут описание работы 
разработчиком. ",
],
[
"name" => "Дворник",
...
"dateEnd" => "Январь 2015",
"description" => "Тут описание работы дворником тут описание работы
дворником тут описание работы дворником тут описание работы дворником
тут описание работы дворником .",
],
[
"name"=> "Главбух в газпроме",
"dateStart" => "Январь 2000",
"dateEnd" => "Январь 2010",
"description" => "Описание работы главбуха в газпроме 
Описание работы главбуха в газпроме Описание работы главбуха в газпроме
Описание работы главбуха в газпроме Описание работы главбуха в газпроме.",
],
];
?>
